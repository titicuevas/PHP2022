...
<body>
    ...
    $depart =       (isset($_GET['departamentos'])) ? trim($_GET['departamentos']) : null;
    ?>
    <div>
        <form action="" method="get">
            <fieldset>
                ...
                <p>
                    <label>
                        Departamentos:
                        <input type="text" name="departamentos" size="8" value="<?= $depart ?>">
                    </label>
                </p>
    ...
    $sent = $pdo->prepare('SELECT COUNT(*)
                             FROM departamentos
                            WHERE codigo BETWEEN :desde_codigo AND :hasta_codigo AND denominacion = :departamentos');
    $sent->execute([
